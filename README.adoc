...
----
include::src/examples/java/com/github/janbeernink/classdependencyscanner/example/StringGraph.java[tag=graphCreation]
----
...
[source,java,indent=0]
----
include::src/examples/java/com/github/janbeernink/classdependencyscanner/example/StringGraph.java[tag=iterate]
----
